...
Usage:
    python VNA_Enhanced.py                    # Default sweep 1Hz-1MHz
    python VNA_Enhanced.py -b 100 -e 10000   # Custom frequency range
    python VNA_Enhanced.py -z 1000           # Impedance measurement
    python VNA_Enhanced.py -p 20             # 20 points per decade
    python VNA_Enhanced.py -v 2.0            # 2V amplitude
    python VNA_Enhanced.py -n                # No plotting
    python VNA_Enhanced.py -l                # List frequencies only
"""
...
Usage: python VNA_Enhanced.py [options]
...
Examples:
  python VNA_Enhanced.py -b 100 -e 10000 -p 20
  python VNA_Enhanced.py -z 1000 -v 2.0
  python VNA_Enhanced.py -l -b 1000 -e 100000
"""
    )
    sys.exit(0)
...
def find_instruments(rm):
    ...
    for resource in resources:
        ...
        if any(
            ...
            for pattern in ["won", "ag1022", "ag 1022", "ag1022"]
        ):
            won_device = resource
    ...
    if not won_device:
        raise VNAError("OWON AG 1022 not found. Check USB connection and drivers.")
...
class OWONAG1022:
    """OWON AG 1022 Signal Generator interface."""
    ...
    def set_frequency(self, freq):
        """Set frequency in Hz."""
        self.device.write(f"FREQ {freq:.3f}")

    def set_amplitude(self, amplitude):
        """Set amplitude in V."""
        self.device.write(f"VOLT {amplitude:.2f}")
...
def main():
    ...
    try:
        ...
        won_resource, rtb_resource = find_instruments(rm)
        won = OWONAG1022(won_resource)
...
def plot_results(vna_data, show_impedance, log_scale):
    ...
    fig.canvas.set_window_title("VNA Transfer Function")
    plt.title("Channel 2 : Channel 1 Transfer Function")
    ...
    if show_impedance:
        ...
        fig2.canvas.set_window_title("VNA Impedance")
